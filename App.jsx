    ...
    <nav className={`nav${scrolled ? ' scrolled' : ''}`}>
      <div className="container nav__inner">
        ...
        <div className="nav__cta">
          ...
          <a href="https://swiy.co/demochat" target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-sm">Start for FREE <Icon name="arrow" size={16}/></a>
      ...
      <div className="container hero__inner">
        <div>
          ...
          <div className="hero__ctas">
            <a href="https://swiy.co/demochat" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Start for FREE <Icon name="arrow" size={16}/></a>
